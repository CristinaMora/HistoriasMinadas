...
public class Turismo : MonoBehaviour
{
   ...
   public void cordobaCuandoIr()
    ...
    public void cordobaTransporte()
    {
        ...
        {
            _explicacion.gameObject.SetActive(true);
            _explicacion.text = "En Granada lo recomendable es ir andando a todos los sitios y disfrutar de sus edificios hist�ricos. Tambi�n cuenta con transporte p�blico, \npara asi hacer m�s accesible su escarpado terreno a personas con discapacodad o mayores.";
        }
    ...
    public void cordobaquever()
    {
        ...
        {
            _explicacion.gameObject.SetActive(true);
            _explicacion.text = "Alhambra \n Mirador San Nicol�s \n Albaic�n \n San Mat�as \n Famosa calle:  Pedro Antonio Alarc�n \n Parque Lorca \n ";
        }
    ...
    public void cordobadondecomer()
    {
        ...
        {
            _explicacion.gameObject.SetActive(true);
            _explicacion.text = "Granada destaca por su comida, las tapas sobretodo. \n Lo mas sorprendente acaba siendo el precio. Una ubicaci�n muy amable al bolsillo. \n En la mayor�a de bares tienes una  bebida con tapa  por un m�dico precio. \n";
        }
    }
